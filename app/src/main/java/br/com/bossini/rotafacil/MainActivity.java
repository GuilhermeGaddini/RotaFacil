package br.com.bossini.rotafacil;
...
import br.com.bossini.rotafacil.R;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        distanciaPercorrida = (TextView)findViewById( R.id.distanciaPercorrida );
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == REQUEST_PERMISSION_GPS){
            ...
            else{ Toast.makeText(this, getString(R.string.gpsNecessario), Toast.LENGTH_SHORT).show();
            }
        }
    }
